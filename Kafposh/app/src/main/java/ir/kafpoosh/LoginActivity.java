...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                if (userEmail.getText().toString().matches("") || userPassword.getText().toString().matches("")) {
                    ...
                    if (online()) {
                        ...
                        editor.putString("pass", userPassword.getText().toString());
                        editor.commit();
                        editor.apply();
        ...
        forgotPassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(LoginActivity.this, "جهت بازیابی با مدیر سایت تماس حاصل فرمایید.", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private class AsyncFetch_login extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                flag = mainObject.getBoolean("is_login");
