...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //  public	static	final	String	F1S1V7	=	"f1s1v7";
    ...
    private static final String TABLE_NAME_state = "_state";
    public static final String state_COLUMN_ID = "id";
    public static final String state_COLUMN_name = "name";
    public static final String state_COLUMN_phone = "phone_code";


    private static final String TABLE_NAME_city = "_city";
    public static final String city_COLUMN_ID = "id";
    public static final String city_COLUMN_stateid = "state_id";
    public static final String city_COLUMN_name = "name";

    private static final String TABLE_NAME_village = "_village";
    public static final String village_COLUMN_ID = "id";
    public static final String village_COLUMN_stateid = "state_id";
    public static final String village_COLUMN_cityid = "city_id";
    public static final String village_COLUMN_NAME = "name";
    ...
    private static final String TABLE_NAME_car_reghabati = "_car_compare";
    public static final String reghabati_COLUMN_ID = "id";
    public static final String reghabati_COLUMN_modelid = "model_id";
    public static final String reghabati_COLUMN_typeid = "type_id";
    public static final String reghabati_COLUMN_thiscar = "this_car";
    public static final String reghabati_COLUMN_car1 = "compare_01";
    public static final String reghabati_COLUMN_car2 = "compare_02";
    public static final String reghabati_COLUMN_car3 = "compare_03";
    public static final String reghabati_COLUMN_car4 = "compare_04";
    public static final String reghabati_COLUMN_car5 = "compare_05";
    public static final String reghabati_COLUMN_car6 = "compare_06";
    public static final String reghabati_COLUMN_car7 = "compare_07";
    public static final String reghabati_COLUMN_car8 = "compare_08";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_ITEM_TABLE_8 = "CREATE TABLE " + TABLE_NAME_state + "(" +

                state_COLUMN_ID + " INTEGER PRIMARY KEY," +
                state_COLUMN_phone + " NVARCHAR(10),"+
                state_COLUMN_name + " NVARCHAR(100))";



        String CREATE_ITEM_TABLE_9 = "CREATE TABLE " + TABLE_NAME_city + "(" +

                city_COLUMN_ID + " INTEGER PRIMARY KEY," +
                city_COLUMN_stateid + " INTEGER,"+
                city_COLUMN_name + " NVARCHAR(100))";


        String CREATE_ITEM_TABLE_10 = "CREATE TABLE " + TABLE_NAME_village + "(" +

                village_COLUMN_ID + " INTEGER PRIMARY KEY," +
                village_COLUMN_stateid + " INTEGER,"+
                village_COLUMN_cityid + " INTEGER,"+
                village_COLUMN_NAME + " NVARCHAR(100))";





        String CREATE_ITEM_TABLE_11 = "CREATE TABLE " + TABLE_NAME_car_reghabati + "(" +

                reghabati_COLUMN_ID + " INTEGER PRIMARY KEY," +
                reghabati_COLUMN_modelid + " INTEGER,"+
                reghabati_COLUMN_typeid + " INTEGER,"+
                reghabati_COLUMN_thiscar + " NVARCHAR(100),"+
                reghabati_COLUMN_car1 + " NVARCHAR(100),"+
                reghabati_COLUMN_car2 + " NVARCHAR(100),"+
                reghabati_COLUMN_car3 + " NVARCHAR(100),"+
                reghabati_COLUMN_car4 + " NVARCHAR(100),"+
                reghabati_COLUMN_car5 + " NVARCHAR(100),"+
                reghabati_COLUMN_car6 + " NVARCHAR(100),"+
                reghabati_COLUMN_car7 + " NVARCHAR(100),"+
                reghabati_COLUMN_car8 + " NVARCHAR(100))";
        ...
        String CREATE_ITEM_TABLE_f1 = "CREATE TABLE " + TABLE_NAME_form_1 + "(" +
       ...
       String CREATE_ITEM_TABLE_f2 = "CREATE TABLE " + TABLE_NAME_form_2 + "(" +
               COLUMN_ID + " INTEGER PRIMARY KEY," +
               COLUMN_ID_USER + " NVARCHAR(100)," +
               COLUMN_LONG + " NVARCHAR(100)," +
               COLUMN_LATI + " NVARCHAR(100)," +
        ...
        db.execSQL(CREATE_ITEM_TABLE_f1);
        ...
        db.execSQL(CREATE_ITEM_TABLE_8);
        db.execSQL(CREATE_ITEM_TABLE_9);
        db.execSQL(CREATE_ITEM_TABLE_10);
        db.execSQL(CREATE_ITEM_TABLE_11);
...
*/
    ...
    public void addDataCarModel(String jsonstring) throws JSONException {
        ...
        try
        {
            ...
            for(int i=1;i<=jsonObj.length();i++){
                JSONObject json_data = jsonObj.getJSONObject(Integer.toString(i));
                valuesword.put(model_COLUMN_id_fac, json_data.getString(model_COLUMN_id_fac));
                valuesword.put(model_COLUMN_id_bra, json_data.getString(model_COLUMN_id_bra));
    ...
    public void addDataState(String jsonstring) throws JSONException {
        ...
        try
        {
            for(int i=1;i<=jsonObj.length();i++){
                JSONObject json_data = jsonObj.getJSONObject(Integer.toString(i));
                valuesword.put(state_COLUMN_phone, json_data.getString("phone_code"));
                valuesword.put(type_COLUMN_NAME, json_data.getString("name"));

                db.insert(TABLE_NAME_state, null, valuesword);
            }
    ...
    public void addDataCity(String jsonstring) throws JSONException {
        ...
        try
        {
            ...
            for(int i=1;i<=jsonObj.length();i++){
                JSONObject json_data = jsonObj.getJSONObject(Integer.toString(i));
                valuesword.put(city_COLUMN_stateid, json_data.getString("state_id"));
                valuesword.put(city_COLUMN_name, json_data.getString("name"));
                db.insert(TABLE_NAME_city, null, valuesword);
            }
    ...
    public void addDataVillage(String jsonstring) throws JSONException {
        ...
        try
        {
            ...
            for(int i=1;i<=jsonObj.length();i++){
                JSONObject json_data = jsonObj.getJSONObject(Integer.toString(i));
                valuesword.put(village_COLUMN_stateid, json_data.getString("state_id"));
                valuesword.put(village_COLUMN_cityid, json_data.getString("city_id"));
                valuesword.put(type_COLUMN_NAME, json_data.getString("name"));
                db.insert(TABLE_NAME_village, null, valuesword);
            }
    ...
    //show one row in table for view
    public List<String> viewOneRowState(){
        //Select All Query
        List<String> list = new ArrayList<String>();


        String selectQuery = "SELECT  *  FROM "+TABLE_NAME_state +" ;";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);//selectQuery,selectedArguments
        Integer count=0;
        count = cursor.getCount();
        ...
        while (cursor.moveToNext()) {
            ...
            list.add(cursor.getString(0)+"#%"+cursor.getString(2)+"#%"+cursor.getString(1));//"1#%esfehan#%021"
        }
    ...
    public List<String> viewOneRowCity(String state_id){

        List<String> list = new ArrayList<String>();
        String selectQuery = "SELECT * FROM "+TABLE_NAME_city+ " WHERE state_id ='"+state_id+"';";
        SQLiteDatabase db = this.getReadableDatabase();
    ...
    public List<String> viewOneRowVillage(String state_id,String city_id){

        List<String> list = new ArrayList<String>();
        String selectQuery = "SELECT * FROM "+TABLE_NAME_village+ " WHERE state_id ='"+state_id+"' AND city_id='"+city_id+"';";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);

        while (cursor.moveToNext()) {
            list.add(cursor.getString(0)+"#%"+cursor.getString(3));
        }
    ...
    public void addDataCarComper(String jsonstring) throws JSONException {
        ...
        try
        {
            ...
            for(int i=1;i<=jsonObj.length();i++){
                JSONObject json_data = jsonObj.getJSONObject(Integer.toString(i));
                valuesword.put(reghabati_COLUMN_modelid, json_data.getString("model_id"));
                valuesword.put(reghabati_COLUMN_typeid, json_data.getString("type_id"));
                valuesword.put(reghabati_COLUMN_thiscar, json_data.getString("this_car"));

                valuesword.put(reghabati_COLUMN_car1, json_data.getString("compare_01"));
                valuesword.put(reghabati_COLUMN_car2, json_data.getString("compare_02"));
                valuesword.put(reghabati_COLUMN_car3, json_data.getString("compare_03"));
                valuesword.put(reghabati_COLUMN_car4, json_data.getString("compare_04"));
                valuesword.put(reghabati_COLUMN_car5, json_data.getString("compare_05"));
                valuesword.put(reghabati_COLUMN_car6, json_data.getString("compare_06"));
                valuesword.put(reghabati_COLUMN_car7, json_data.getString("compare_07"));
                valuesword.put(reghabati_COLUMN_car8, json_data.getString("compare_08"));

                db.insert(TABLE_NAME_car_reghabati, null, valuesword);
            }
    ...
    public List<String> viewOneRowCarComper(String idmodel){
        //Select All Query
        List<String> list = new ArrayList<String>();


        String selectQuery = "SELECT  *  FROM "+TABLE_NAME_car_reghabati +" WHERE model_id='"+idmodel+"' ;";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);

        while (cursor.moveToNext()) {
            list.add(cursor.getString(0)+"#%"+cursor.getString(1)+"#%"+cursor.getString(2)+"#%"+cursor.getString(3)+"#%"+cursor.getString(4)+"#%"+cursor.getString(5)+"#%"+cursor.getString(6)+"#%"+cursor.getString(7)+"#%"+cursor.getString(8)+"#%"+cursor.getString(9)+"#%"+cursor.getString(10)+"#%"+cursor.getString(11));
        }
    ...
    public List<String> viewAllBrand(){
        //Select All Query
        List<String> list = new ArrayList<String>();

        String selectQuery = "SELECT  *  FROM "+TABLE_NAME_barand +" ;";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);//selectQuery,selectedArguments
        Integer count=0;
        count = cursor.getCount();
    ...
    public List<String> viewAllBrand_savari(){
        //Select All Query
        List<String> list = new ArrayList<String>();
        ...
        String selectQuery = "SELECT brand_id FROM " + TABLE_NAME_tip + " WHERE type_id = '1';";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);//selectQuery,selectedArguments
        ...
        if (cursor.getCount() > 0) {
            ...
            while (cursor.moveToNext()) {
                setidbrand.add(cursor.getString(0));
            }

            for (String da : setidbrand) {
                word = da + "," + word;
            }
            word = word.substring(0, word.length() - 1);


            String selectQuery1 = "SELECT  *  FROM " + TABLE_NAME_barand + " WHERE id IN ( " + word + " );";
            SQLiteDatabase db1 = this.getReadableDatabase();
            Cursor cursor1 = db1.rawQuery(selectQuery1, null);//selectQuery,selectedArguments
            Integer count = 0;
            ...
            while (cursor1.moveToNext()) {
               ...
               // list.add(cursor1.getString(0) + "#%" + cursor1.getString(1) + "#%" + cursor1.getString(2));

                factoryBrand = cursor1.getString(2)+" - ( "+viewOneRowFactory( cursor1.getString(1) )+" )";

                list.add(cursor1.getString(0)+"#%"+cursor1.getString(1)+"#%"+factoryBrand);
            }
    ...
    public List<String> viewRowBrand(Set<String> setstr){
        //Select All Query
        List<String> list = new ArrayList<String>();
        String word="";

        for(String da : setstr){
            //valuesword.put("id", "");
            word = da + "," + word;
        }
        ...
        String selectQuery = "SELECT  *  FROM "+TABLE_NAME_barand +" WHERE id IN ( "+word+" );";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);//selectQuery,selectedArguments
        Integer count=0;
        count = cursor.getCount();
        ...
        while (cursor.moveToNext()) {
            ...
            factoryBrand = cursor.getString(2)+" - ( "+viewOneRowFactory( cursor.getString(1) )+" )";

            list.add(cursor.getString(0)+"#%"+cursor.getString(1)+"#%"+factoryBrand);
        }
    ...
    public List<String> viewAllBrandForFactory(String idfactory){
        //Select All Query
        List<String> list = new ArrayList<String>();

        String selectQuery = "SELECT  *  FROM "+TABLE_NAME_barand +" WHERE factory_id='"+idfactory+"';";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);//selectQuery,selectedArguments
    ...
    public List<String> viewRowAllBrand(){
        //Select All Query
        List<String> list = new ArrayList<String>();
        ...
        while (cursor.moveToNext()) {
            ...
            list.add(cursor.getString(0)+"#%"+cursor.getString(1)+"#%"+cursor.getString(2));//id-factory_id-brandname
        }
    ...
    public List<String> viewRowFactory(Set<String> setstr){
        //Select All Query
        List<String> list = new ArrayList<String>();
        String word="";
        ...
        String selectQuery = "SELECT  *  FROM "+TABLE_NAME_carfactory +" WHERE id IN ( "+word+" );";
    ...
    public List<String> viewFactory_tv(String typetv){
        //Select All Query
        List<String> list = new ArrayList<String>();
        String word="";

        String selectQuery = "SELECT factory_id FROM "+TABLE_NAME_tip+ " WHERE export_id ='"+typetv+"';";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);//selectQuery,selectedArguments
        Set<String> setidfactory = new HashSet<String>();

        Integer conter=0;

        while (cursor.moveToNext()) {
            setidfactory.add(cursor.getString(0));
        }

        for(String da : setidfactory){
            word = da + "," + word;
        }
        ...
        selectQuery = "SELECT  *  FROM "+TABLE_NAME_carfactory +" WHERE id IN ( "+word+" );";


        SQLiteDatabase db1 = this.getReadableDatabase();
        Cursor cursor1 = db1.rawQuery(selectQuery, null);//selectQuery,selectedArguments

        while (cursor1.moveToNext()) {

            list.add(cursor1.getString(0)+"#%"+cursor1.getString(1));
        }
    ...
    public List<String> nametip(String mid){
        //Select All Query
        List<String> list = new ArrayList<String>();


        String selectQuery = "SELECT id,tip_name,min_price,max_price FROM "+TABLE_NAME_tip+ " WHERE model_id ='"+mid+"';";
        // String selectQuery = "SELECT * FROM "+TABLE_NAME_model+ ";";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);//selectQuery,selectedArguments
        Integer count=0;
        count = cursor.getCount();
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    public List<String> viewRowModel(String bid){
        //Select All Query
        List<String> list = new ArrayList<String>();


        String selectQuery = "SELECT * FROM "+TABLE_NAME_model+ " WHERE brand_id ='"+bid+"';";
        // String selectQuery = "SELECT * FROM "+TABLE_NAME_model+ ";";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);//selectQuery,selectedArguments
        Integer count=0;
    ...
    public List<String> viewRowModel_savari(String bid) {
        //Select All Query
        List<String> list = new ArrayList<String>();

        String selectQuery = "SELECT model_id FROM " + TABLE_NAME_tip + " WHERE brand_id ='" + bid + "' AND type_id = '1';";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);//selectQuery,selectedArguments
        Set<String> setidmodel = new HashSet<String>();

        String word = "";
        if (cursor.getCount() > 0) {

            while (cursor.moveToNext()) {
                setidmodel.add(cursor.getString(0));
            }

            for (String da : setidmodel) {
                word = da + "," + word;
            }
            word = word.substring(0, word.length() - 1);

            String selectQuery1 = "SELECT * FROM " + TABLE_NAME_model + " WHERE id IN ( " + word + " );";
            SQLiteDatabase db1 = this.getReadableDatabase();
            Cursor cursor1 = db1.rawQuery(selectQuery1, null);//selectQuery,selectedArguments

            while (cursor1.moveToNext()) {
                list.add(cursor1.getString(0) + "#%" + cursor1.getString(3));
            }
            cursor1.close();
            db1.close();
        }//end if
    ...
    public List<String> viewRowTip(String tid){
        //Select All Query
        List<String> list = new ArrayList<String>();


        String selectQuery = "SELECT * FROM "+TABLE_NAME_tip+ " WHERE type_id='"+tid+"';";
        // String selectQuery = "SELECT * FROM "+TABLE_NAME_model+ ";";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery, null);//selectQuery,selectedArguments
        Integer count=0;
    ...
    public String viewOneRowFactory(String factoryID){
        //Select All Query
        String factoryName = "";

        String selectQuery = "SELECT factory_name FROM "+TABLE_NAME_carfactory +" WHERE id = "+factoryID+" LIMIT 0, 1;";
        ...
        while (cursor.moveToNext()) {
            factoryName = cursor.getString(0);
        }
