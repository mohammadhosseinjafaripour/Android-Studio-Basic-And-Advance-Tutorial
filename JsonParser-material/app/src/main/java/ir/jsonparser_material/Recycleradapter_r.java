...
public class Recycleradapter_r extends RecyclerView.Adapter<Recycleradapter_r.MyHolder> {
    ...
    public Recycleradapter_r(List<Product> list, ImageLoader imageLoader) {
        this.list = list;
